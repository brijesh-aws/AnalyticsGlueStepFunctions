...
filePath = "s3://{}/data/address".format( confBucketName )
...
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = curratedDB, table_name = "address", transformation_ctx = "datasource0")
...
sink.setFormat("json")
sink.setCatalogInfo( catalogDatabase = confDB, catalogTableName="address" )
